...
/** Source for loading filesystem-based settings. 'user' - Global user settings (~/.course/settings.json). 'project' - Project settings (.course/settings.json). 'local' - Local settings (.course/settings.local.json). */
