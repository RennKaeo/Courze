...
export class RemoteIO extends StructuredIO {
  ...
  constructor(
    ...
    const erVersion = process.env.COURSE_CODE_ENVIRONMENT_RUNNER_VERSION
    if (erVersion) {
    ...
    const refreshHeaders = (): Record<string, string> => {
      ...
      const freshErVersion = process.env.COURSE_CODE_ENVIRONMENT_RUNNER_VERSION
      if (freshErVersion) {
    ...
    this.isBridge = process.env.COURSE_CODE_ENVIRONMENT_KIND === 'bridge'
    ...
    // from GrowthBook (courze_bridge_poll_interval_config
