...
const PROTO_PATH = path.resolve(import.meta.dirname, '../proto/course.proto')
...
const courseProto = protoDescriptor.course.v1
...
export class GrpcServer {
  ...
  constructor() {
    ...
    this.server.addService(courseProto.AgentService.service, {
      ...
      try {
        if (clientMessage.request) {
          ...
          engine = new QueryEngine({
            ...
            mcpClients: [],
            // Register Course Code's built-in agents (general-purpose,
