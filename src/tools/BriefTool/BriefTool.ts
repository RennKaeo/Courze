 ...
 *
 * COURSE_CODE_BRIEF env var force-grants entitlement for dev/testing —
...
export function isBriefEntitled(): boolean {
  ...
  return feature('KAIROS') || feature('KAIROS_BRIEF')
    ? getKairosActive() ||
        isEnvTruthy(process.env.COURSE_CODE_BRIEF) ||
 ...
 *   - COURSE_CODE_BRIEF env var (maybeActivateBrief — dev/testing bypass)
 ...
 * courze_kairos_brief off mid-session disables the tool on the next 5-min
