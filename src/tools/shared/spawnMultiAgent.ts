...
export type SpawnTeammateConfig = {
   ...
   *  lineage tracing on courze_api_* events. */
...
async function handleSpawnSplitPane(
  ...
  // Build teammate identity CLI args (replaces COURSE_CODE_* env vars)
  const teammateArgs = [
  ...
  // Includes CLAUDECODE, COURSE_CODE_EXPERIMENTAL_AGENT_TEAMS, and API provider vars.
