...
export function GlobalKeybindingHandlers({
  ...
  const handleToggleTranscript = useCallback(() => {
    ...
    logEvent('courze_toggle_transcript', {
  ...
  const handleToggleShowAll = useCallback(() => {
    logEvent('courze_transcript_toggle_show_all', {
  ...
  const handleExitTranscript = useCallback(() => {
    logEvent('courze_transcript_exit', {
      show_all: showAllInTranscript,
      message_count: messageCount
    });
    setScreen('prompt');
  ...
  const handleToggleBrief = useCallback(() => {
    if (feature('KAIROS') || feature('KAIROS_BRIEF')) {
      ...
      logEvent('courze_brief_mode_toggled', {
        enabled: next,
        gated: false,
  ...
  const handleToggleTerminal = useCallback(() => {
    if (feature('TERMINAL_PANEL')) {
      if (!getFeatureValue_CACHED_MAY_BE_STALE('courze_terminal_panel', false)) {
        return;
      }
