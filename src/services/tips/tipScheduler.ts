...
import { shouldShowEarningTip, buildEarningTip } from './courseEarn.js'
...
export async function getTipToShowOnSpinner(
  ...
  // Opt-in earning users (`/ads on <code>`) see Courze sponsored tips on a
