...
<html lang="en">
  ...
  <body>
    ...
    <p>You can return to Course Code now.</p>
    <p>Course Code will finish activating your new Codex OAuth login.</p>
  </body>
</html>`
}
...
<html lang="en">
  ...
  <body>
    ...
    <p>${safeMessage}</p>
    <p>You can close this window and try again in Course Code.</p>
  </body>
</html>`
}
...
<html lang="en">
  ...
  <body>
    ...
    <p>You can close this window and retry in Course Code.</p>
  </body>
</html>`
}
