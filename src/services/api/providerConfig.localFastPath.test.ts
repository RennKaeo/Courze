...
const ENV_VAR = 'COURSE_LOCAL_FAST_PATH'
...
describe('getLocalFastPathConfig — explicit env override', () => {
  test('COURSE_LOCAL_FAST_PATH=1 forces on against a public host', () => {
  ...
  test('COURSE_LOCAL_FAST_PATH=0 forces off against localhost', () => {
