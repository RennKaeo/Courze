 ...
 * terminal — it's the allowlist (courze_harbor_ledger). A compromised
...
/**
 * GrowthBook runtime gate — separate from the channels gate (courze_harbor)
...
export function isChannelPermissionRelayEnabled(): boolean {
  return getFeatureValue_CACHED_MAY_BE_STALE('courze_harbor_permissions', false)
}
