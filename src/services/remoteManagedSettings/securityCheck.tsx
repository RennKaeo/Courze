...
export async function checkManagedSettingsSecurity(cachedSettings: SettingsJson | null, newSettings: SettingsJson | null): Promise<SecurityCheckResult> {
  ...
  logEvent('courze_managed_settings_security_dialog_shown', {});
      ...
      const {
        unmount
          ...
          <KeybindingSetup>
            ...
            logEvent('courze_managed_settings_security_dialog_accepted', {});
            unmount();
            void resolve('approved');
          }} onReject={() => {
            logEvent('courze_managed_settings_security_dialog_rejected', {});
            unmount();
