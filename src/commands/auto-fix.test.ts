...
describe('/auto-fix command prompt', () => {
  test('points project and local settings at canonical .course paths', async () => {
    ...
    expect(text).toContain('.course/settings.json')
    expect(text).toContain('.course/settings.local.json')
