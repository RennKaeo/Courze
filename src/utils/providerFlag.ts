 ...
 *
 * Usage:
 *   course --provider openai --model gpt-4o
 *   course --provider gemini --model gemini-2.0-flash
 *   course --provider mistral --model ministral-3b-latest
 *   course --provider ollama --model llama3.2
 *   course --provider anthropic   (default, no-op)
 */
 ...
 *
 * Issue #808: `course --model <name>` should work standalone so users can
