...
async function doInitialize(): Promise<void> {
  ...
  // Pass COURSE_CODE_SKIP_PROMPT_HISTORY via -e so it's set in the initial shell environment
  //
  ...
  const result = await execTmux([
    ...
    'base',
    '-e',
    'COURSE_CODE_SKIP_PROMPT_HISTORY=true',
    ...(getPlatform() === 'windows'
  ...
  // Set COURSE_CODE_SKIP_PROMPT_HISTORY in the tmux GLOBAL environment (-g).
  ...
  await execTmux([
    ...
    'set-environment',
    '-g',
    'COURSE_CODE_SKIP_PROMPT_HISTORY',
    'true',
  ])
