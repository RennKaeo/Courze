 ...
 * rationale. Env var: COURSE_CODE_OAUTH_TOKEN_FILE_DESCRIPTOR.
...
export function getOAuthTokenFromFileDescriptor(): string | null {
  return getCredentialFromFd({
    envVar: 'COURSE_CODE_OAUTH_TOKEN_FILE_DESCRIPTOR',
