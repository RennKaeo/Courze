...
const GCS_BASE =
  'https://downloads.claude.ai/course-code-releases/plugins/claude-plugins-official'
...
export async function fetchOfficialMarketplaceFromGcs(
  ...
  try {
    ...
    // courze_plugin_remote_fetch schema shared with the telemetry PR
    ...
    logEvent('courze_plugin_remote_fetch', {
