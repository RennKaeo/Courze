 ...
 *
 * When COURSE_CODE_PLUGIN_USE_ZIP_CACHE is enabled, plugins are stored as
...
export async function installPluginsForHeadless(): Promise<boolean> {
  ...
  // Register seed marketplaces (COURSE_CODE_PLUGIN_SEED_DIR) before diffing.
  ...
  // which composes correctly with COURSE_CODE_PLUGIN_SEED_DIR: seed registers
