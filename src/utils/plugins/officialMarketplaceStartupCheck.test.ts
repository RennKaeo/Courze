...
mock.module('../config.js', () => ({
  ...
  getManagedClaudeRulesDir: () => '/tmp/course-managed-rules',
  getMemoryPath: () => '/tmp/course-memory.md',
  getOrCreateUserID: () => 'test-user-id',
  getProjectPathForConfig: () => '/tmp/course-project-config.json',
  getRemoteControlAtStartup: () => false,
  getUserClaudeRulesDir: () => '/tmp/course-user-rules',
...
mock.module('./marketplaceManager.js', () => ({
  ...
  getMarketplacesCacheDir: () => '/tmp/course-marketplaces',
  ...
  test('uses known marketplaces as the installed source of truth', async () => {
    knownMarketplaces = {
      'claude-plugins-official': {
        installLocation: '/tmp/course-marketplaces/claude-plugins-official',
      },
    }
