...
async function installFromGitHub(
  ...
  const gitUrl = isEnvTruthy(process.env.COURSE_CODE_REMOTE)
 ...
 * COURSE_CODE_REMOTE) or any URL that passes validateGitUrl (https, http,
 * file, git@ ssh).
 */
 ...
 *
 * COURSE_CODE_SYNC_PLUGIN_INSTALL=1 delegates to the full loader — that
