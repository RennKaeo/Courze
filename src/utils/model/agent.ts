...
export function getAgentModel(
  ...
  if (process.env.COURSE_CODE_SUBAGENT_MODEL) {
    return parseUserSpecifiedModel(process.env.COURSE_CODE_SUBAGENT_MODEL)
  }
 ...
 * See https://github.com/anthropics/course-code/issues/30815.
 *
