...
// Native NSPasteboard reader. GrowthBook gate courze_collage_kaleidoscope is
...
export async function hasImageInClipboard(): Promise<boolean> {
  ...
  if (
    ...
    getFeatureValue_CACHED_MAY_BE_STALE('courze_collage_kaleidoscope', true)
  ) {
