...
const HOOK_CHAINS_CONFIG_ENV_PATH = 'COURSE_CODE_HOOK_CHAINS_CONFIG_PATH'
const HOOK_CHAINS_ENABLED_ENV = 'COURSE_CODE_ENABLE_HOOK_CHAINS'
const DEFAULT_HOOK_CHAINS_RELATIVE_PATH = join('.course', 'hook-chains.json')
  ...
  try {
    ...
    if (
      ...
      const created = await envApi.createDefaultCloudEnvironment(
        'Course Code Self-Healing Warmup',
      )
      selection = {
