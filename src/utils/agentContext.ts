 ...
 * variables instead: COURSE_CODE_AGENT_ID, COURSE_CODE_PARENT_SESSION_ID
 *
...
export type SubagentContext = {
  ...
  agentId: string
  /** The team lead's session ID (from COURSE_CODE_PARENT_SESSION_ID env var), undefined for main REPL subagents */
 ...
 * courze_api_success/error per invocation, so a non-NULL value downstream
