...
const pathsBySource: Record<SettingSource, string | null> = {
  userSettings: normalize('/tmp/course/user/settings.json'),
  projectSettings: normalize('/tmp/course/project/.course/settings.json'),
  localSettings: normalize('/tmp/course/project/.course/settings.local.json'),
  flagSettings: null,
  policySettings: normalize('/tmp/course/managed/managed-settings.json'),
}
...
async function importFreshModule(): Promise<SettingsChangeDetectorModule> {
  ...
  activeDetector._setDependenciesForTesting({
    ...
    getManagedSettingsDropInDir: () =>
      normalize('/tmp/course/managed/managed-settings.d'),
