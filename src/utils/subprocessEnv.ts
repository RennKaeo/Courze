...
const GHA_SUBPROCESS_SCRUB = [
  ...
  // course-code-action-specific duplicates — action JS consumes these during
 ...
 * servers, shell hooks).
 *
 * Gated on COURSE_CODE_SUBPROCESS_ENV_SCRUB. course-code-action sets this
...
export function subprocessEnv(): NodeJS.ProcessEnv {
  ...
  if (!isEnvTruthy(process.env.COURSE_CODE_SUBPROCESS_ENV_SCRUB)) {
