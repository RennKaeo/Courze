 ...
 * (e.g. "@renskaeo/courze@latest") with the given package manager.
 */
export function getGlobalInstallArgs(
  ...
  switch (pm) {
    ...
    case 'yarn':
      ...
      // for the documented course install path.
...
/**
 * Detect which package manager owns the currently running Course Code install.
 *
 * Strategy:
