...
export function isPlanModeRequired(): boolean {
  ...
  return isEnvTruthy(process.env.COURSE_CODE_PLAN_MODE_REQUIRED)
}
 ...
 * 2. Either:
 *    - Our COURSE_CODE_AGENT_ID matches the leadAgentId, OR
 *    - We have no COURSE_CODE_AGENT_ID set (backwards compat: the original
