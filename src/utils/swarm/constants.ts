 ...
 */
export const TEAMMATE_COMMAND_ENV_VAR = 'COURSE_CODE_TEAMMATE_COMMAND'
 ...
 */
export const TEAMMATE_COLOR_ENV_VAR = 'COURSE_CODE_AGENT_COLOR'
 ...
 */
export const PLAN_MODE_REQUIRED_ENV_VAR = 'COURSE_CODE_PLAN_MODE_REQUIRED'
