 ...
 *
 * When COURSE_CODE_PROVIDER_MANAGED_BY_HOST is truthy in the spawn env, these
...
const PROVIDER_MANAGED_ENV_VARS = new Set([
  ...
  'COURSE_CODE_PROVIDER_MANAGED_BY_HOST',
  // Provider selection
...
export const SAFE_ENV_VARS = new Set([
  ...
  'COURSE_CODE_API_KEY_HELPER_TTL_MS',
  'COURSE_CODE_DISABLE_EXPERIMENTAL_BETAS',
  'COURSE_CODE_DISABLE_NONESSENTIAL_TRAFFIC',
  'COURSE_CODE_DISABLE_TERMINAL_TITLE',
  'COURSE_CODE_ENABLE_TELEMETRY',
  'COURSE_CODE_EXPERIMENTAL_AGENT_TEAMS',
  'COURSE_CODE_IDE_SKIP_AUTO_INSTALL',
