 ...
 * @param teamName - Optional team name (defaults to COURSE_CODE_TEAM_NAME env var or 'default')
 */
...
export type SandboxPermissionRequestMessage = {
  ...
  requestId: string
  /** Worker's COURSE_CODE_AGENT_ID */
  workerId: string
  /** Worker's COURSE_CODE_AGENT_NAME */
  workerName: string
  /** Worker's COURSE_CODE_AGENT_COLOR */
  workerColor?: string
 ...
 * @param teamName - Optional team name (defaults to COURSE_CODE_TEAM_NAME env var)
