export const en = {
  ...
  'commands.doctor.description':
    'Diagnose and verify your Course Code installation and settings',
  ...
  'commands.insights.description':
    'Generate a report analyzing your Course Code sessions',
  ...
  'commands.plugin.description': 'Manage Course Code plugins',
  ...
  'commands.stats.description':
    'Show your Course Code usage statistics and activity',
  'commands.status.description':
    'Show Course Code status including version, model, account, API connectivity, and tool statuses',
  'commands.statusline.description': "Set up Course Code's status line UI",
  'commands.stickers.description': 'Order Course Code stickers',
  ...
  'commands.wiki.description':
    'Initialize and inspect the Course Code project wiki',
