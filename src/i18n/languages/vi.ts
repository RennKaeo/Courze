export const vi = {
  ...
  'commands.doctor.description':
    'Chẩn đoán và xác minh cài đặt Course Code',
  ...
  'commands.insights.description':
    'Tạo báo cáo phân tích các phiên Course Code',
  ...
  'commands.plugin.description': 'Quản lý plugin Course Code',
  ...
  'commands.stats.description':
    'Hiện thống kê sử dụng và hoạt động Course Code',
  'commands.status.description':
    'Hiển thị trạng thái Course Code bao gồm phiên bản, mô hình, tài khoản, kết nối API và trạng thái công cụ',
  'commands.statusline.description':
    'Thiết lập giao diện dòng trạng thái của Course Code',
  'commands.stickers.description': 'Đặt mua sticker Course Code',
  ...
  'commands.wiki.description':
    'Khởi tạo và kiểm tra wiki dự án Course Code',
  ...
  'skills.debug.ant.description':
    'Debug phiên Courze hiện tại bằng cách đọc debug log của phiên. Bao gồm toàn bộ event logging',
