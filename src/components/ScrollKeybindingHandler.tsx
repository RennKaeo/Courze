...
// event/notch — users on those can set COURSE_CODE_SCROLL_SPEED=3 to match
...
/** Read COURSE_CODE_SCROLL_SPEED, default 1, clamp (0, 20].
 ...
 *  set COURSE_CODE_SCROLL_SPEED=3 to match vim/nvim/opencode. We can't
...
export function readScrollSpeedBase(): number {
  const raw = process.env.COURSE_CODE_SCROLL_SPEED;
  if (!raw) return 1;
