...
// '.claude/...' and drifted from the canonical '.course/...'.
//
...
//      literal '.course/...' (catches a settings.ts regression).
...
const EXPECTED = {
  projectSettings: '.course/settings.json',
  localSettings: '.course/settings.local.json',
} as const
...
test('getRelativeSettingsFilePathForSource returns the canonical .course/ paths', () => {
