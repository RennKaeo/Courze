...
function StatusLineInner({
  ...
  // would leak into this session's statusline (anthropics/course-code#37596).
  ...
  useEffect(() => {
    ...
    if (statusLine) {
      logEvent('courze_status_line_mount', {
      ...
      // and courze_status_line_mount above fires anyway so telemetry looks fine.
