  ...
  useInput((_input, key) => {
    if (key.return && referralLink) {
      void setClipboard(referralLink).then(raw => {
        ...
        logEvent('courze_guest_passes_link_copied', {});
      ...
      <Box flexDirection="column" gap={1}>
        ...
        <Box flexDirection="column" marginLeft={2}>
          <Text dimColor>
            ...
            <Link url={referrerReward ? 'https://support.claude.com/en/articles/13456702-course-code-guest-passes' : 'https://support.claude.com/en/articles/12875061-course-code-guest-passes'}>
              Terms apply.
            </Link>
          </Text>
        </Box>
