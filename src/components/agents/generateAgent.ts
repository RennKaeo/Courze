...
6 **Example agent descriptions**:
  ...
  - examples should be of the form:
    ...
    - <example>
      ...
      assistant: "I'm going to use the ${AGENT_TOOL_NAME} tool to launch the course-code-guide agent to answer the question"
      <commentary>
      Since the user is asking how to use Claude Code, use the course-code-guide agent.
      </commentary>
    </example>
