...
export function getDesktopUpsellConfig(): DesktopUpsellConfig {
  return getDynamicConfig_CACHED_MAY_BE_STALE('courze_desktop_upsell', DESKTOP_UPSELL_DEFAULT);
}
...
export function DesktopUpsellStartup(t0) {
  ...
  if ($[8] === Symbol.for("react.memo_cache_sentinel")) {
    t6 = <Box marginBottom={1}><Text>Use Course Code in the Claude desktop app for visual diffs, live app preview, parallel sessions, and more.</Text></Box>;
    $[8] = t6;
  } else {
    t6 = $[8];
  }
...
function _temp() {
  ...
  logEvent("courze_desktop_upsell_shown", {
    seen_count: newCount
  });
}
