...
export function useUnseenDivider(messageCount: number): {
  ...
  const onScrollAway = useCallback((handle: ScrollBoxHandle) => {
    ...
    //   at max (Sarah Deaton, #course-code-feedback 2026-03-15)
 ...
 *
 * Fullscreen mode defaults on for ants (COURSE_CODE_NO_FLICKER=0 to opt out)
 * and off for external users (COURSE_CODE_NO_FLICKER=1 to opt in).
