...
export function SpinnerWithVerb(props: Props): React.ReactNode {
  ...
  if ((feature('KAIROS') || feature('KAIROS_BRIEF')) && (getKairosActive() || getUserMsgOptIn() && (briefEnvEnabled || getFeatureValue_CACHED_MAY_BE_STALE('courze_kairos_brief', false))) && isBriefOnly && !viewingAgentTaskId) {
