# Course Code Local Agent Playbook

This playbook is a practical guide to run Course Code with a local model (Ollama), work safely, and get strong day-to-day results.
...
If everything is healthy, Course Code starts directly.
...
Or let Course Code recommend the best local model for your goal:
...
- Keep any legacy workspace `.courzerc.json` local; new provider saves use the user config directory.
