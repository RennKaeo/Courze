/**
 * ProcessManager — spawns Course Code in print/SDK mode and manages the
...
class ProcessManager {
  /**
   * @param {object} opts
   * @param {string} opts.command - The course binary (e.g. 'course')
   ...
   */
  constructor(opts) {
    this._command = opts.command || 'course';
