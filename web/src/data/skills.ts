...
export const skills: Skill[] = [
  ...
  },
  {
    ...
    description:
      'Customize keyboard shortcuts: rebind keys, add chord bindings, or modify your keybindings file (default: ~/.course/keybindings.json; override via OPENCLAUDE_CONFIG_DIR).',
  },
]
