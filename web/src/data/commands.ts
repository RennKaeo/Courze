...
export const commands: SlashCommand[] = [
  ...
  { name: 'wiki', description: 'Initialize and inspect the Course Code project wiki', category: 'context', args: '[init|status]' },
  ...
  { name: 'plugin', description: 'Manage Course Code plugins', category: 'tools' },
  ...
  { name: 'statusline', description: "Set up Course Code's status line UI", category: 'customization' },
  ...
  { name: 'stickers', description: 'Order Course Code stickers', category: 'customization' },
  ...
  { name: 'doctor', description: 'Diagnose and verify your Course Code installation and settings', category: 'diagnostics' },
  ...
  { name: 'insights', description: 'Generate a report analyzing your Course Code sessions', category: 'diagnostics' },
  { name: 'release-notes', description: 'View release notes', category: 'diagnostics' },
  { name: 'feedback', description: 'Submit feedback about Course Code', category: 'diagnostics', args: '[report]' },
]
