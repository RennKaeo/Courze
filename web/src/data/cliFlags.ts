...
export const subcommands: Subcommand[] = [
  {
    name: 'mcp',
    usage: 'course mcp [add|remove|list|doctor]',
    description: 'Manage MCP server configuration from the command line.',
  },
  {
    name: 'ssh',
    usage: 'course ssh <host> [dir]',
    description: 'Run Course Code on a remote host over SSH. Deploys the binary and tunnels API auth back through your local machine — no remote setup needed.',
  },
]
