...
const PROTO_PATH = path.resolve(import.meta.dirname, '../src/proto/course.proto')
...
async function main() {
  ...
  const client = new courseProto.AgentService(
    `${host}:${port}`,
  ...
  console.log('\x1b[32mCourse Code gRPC CLI\x1b[0m')
